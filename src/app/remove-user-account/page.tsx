...
export default function RemoveAccountPage() {
    return (
        <div className="min-h-screen text-gray-300 font-sans" style={{backgroundColor: '#111'}}>
            {/* Header */}
            <header className="border-b border-gray-800">
                <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
                    <Image src={logo} alt="PsychoPath Logo" className="h-32 w-auto" />
                    <p className="text-gray-400 mt-1 hidden sm:block">Support & Guidance</p>
                </div>
            </header>
            ...
            <main className="max-w-5xl mx-auto px-6 py-12 md:py-16">
                {/* Page Title */}
                <div className="mb-12">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight">How to Delete Your Account</h2>
                ...
                <section className="mb-12">
                    <h3 className="text-2xl md:text-3xl font-bold text-red-600 mb-6 border-l-4 border-red-600 pl-4">Important Information</h3>
                ...
                {/* Deletion Steps */}
                <section className="mb-12">
                    <h3 className="text-2xl md:text-3xl font-bold text-red-600 mb-6 border-l-4 border-red-600 pl-4">In-App Deletion Steps</h3>
                    <div className="space-y-8">
                        <div className="flex items-start">
                            ...
                            <div className="ml-6">
                                <h4 className="text-xl font-bold text-white">Navigate to Your Profile</h4>
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-6">
                                <h4 className="text-xl font-bold text-white">Find the "Remove Account" Button</h4>
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="ml-6">
                                <h4 className="text-xl font-bold text-white">Confirm Deletion</h4>
                ...
                {/* Contact Support */}
                <section>
                    <h3 className="text-2xl md:text-3xl font-bold text-red-600 mb-6 border-l-4 border-red-600 pl-4">Need Help?</h3>
